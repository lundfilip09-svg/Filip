...
const TRANSLATIONS = {
  no: {
    ...
    'gym.copy_from': 'Kopier øvelser fra', 'gym.copy_empty': 'Tom dag (ingen øvelser)',
    'gym.day_copied': 'Dag opprettet med kopierte øvelser',
    ...
    'po.aim': 'Sikt {lo}–{hi} reps · 3 RIR',
    'po.level_up': '✓ Klarte {hi} m/3 RIR — øk vekt (~{w} {u})',
  ...
  en: {
    ...
    'gym.copy_from': 'Copy exercises from', 'gym.copy_empty': 'Empty day (no exercises)',
    'gym.day_copied': 'Day created with copied exercises',
    ...
    'po.aim': 'Aim {lo}–{hi} reps · 3 RIR',
    'po.level_up': '✓ Hit {hi} w/3 RIR — add weight (~{w} {u})',
