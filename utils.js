...
const TRANSLATIONS = {
  no: {
    ...
    'tp.manage_acts_title': 'Egendefinerte aktiviteter',
    'tp.manage_acts_empty': 'Ingen egendefinerte aktiviteter ennå',
  ...
  en: {
    ...
    'tp.manage_acts_title': 'Custom activities',
    'tp.manage_acts_empty': 'No custom activities yet',
