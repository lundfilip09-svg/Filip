...
const TRANSLATIONS = {
  no: {
    ...
    'dash.open_in_todos': 'Åpne i Gjøremål →',
    ...
    'biz.mrr': 'MRR', 'biz.onetime_year': 'Engang i år',
    'biz.monthly_cost': 'Månedskostnad', 'biz.monthly_result': 'Månedsresultat',
    'biz.deposit_outstanding': 'Utestående depositum', 'biz.deposit_show': 'Vis dem →',
    'biz.avtale': 'Avtale', 'biz.kontrakt_betaling': 'Kontrakt & betaling',
    'biz.faresone': 'Faresone', 'biz.close_panel': 'Lukk',
    'biz.panel_cta_lead': 'Avtal demo', 'biz.panel_cta_tilbud': 'Kopier tilbud',
    'biz.panel_cta_kontrakt': 'Merk som aktiv', 'biz.panel_cta_pauset': 'Gjenaktiver',
    'biz.startdato': 'Startdato', 'biz.bekreftet_dato': 'Bekreftet dato',
    'biz.customers': 'Kunder',
    'biz.customer': 'Kunde', 'biz.contact': 'Kontakt', 'biz.tier': 'Nivå',
    'biz.business_model': 'Forretningsmodell',
    'biz.bm_a': 'Scenario A: Full driftsavtale (Abonnement)',
    'biz.bm_b': 'Scenario B: Serverløs gratis hosting (Engangskjøp)',
    'biz.bm_c': 'Scenario C: Full overføring (Engangs)',
    'biz.bm_custom': 'Egendefinert',
    'biz.profil': 'Profil',
    'biz.mrr_short': 'MRR',
    'biz.sc_a_desc': 'Løpende drift og hosting. Forskudd 25 % ikke-refunderbart før oppstart.',
    'biz.sc_b_desc': 'Gratis serverløs hosting. Ingen kodetilgang for kunde.',
    'biz.sc_c_desc': 'Full overføring til kundens egen Lovable-konto.',
    'biz.sc_a_recommended': 'Anbefalt',
    'biz.sc_a_f1': '1 måneds gjensidig oppsigelsestid',
    'biz.sc_a_f2': 'Overforbruk faktureres separat',
    'biz.sc_b_f1': 'Endringer via byrået, ingen kodetilgang',
    'biz.sc_b_f2': 'Reaktiveringsgebyr {fee} kr etter 90 dager inaktivitet + {rate} kr/t',
    'biz.sc_c_f1': 'Kunden eier løsningen fullt ut etter overføring',
    'biz.sc_c_f2': 'Support etter overføring: {rate} kr/t',
    'biz.tier_incl_lav': 'Hosting, SSL, oppetid — 0 endringer',
    'biz.tier_incl_medium': 'Maks 2 mikroendringer/mnd',
    'biz.tier_incl_hoy': 'Ukentlige justeringer (1 økt/uke)',
    ...
    'biz.type_sales': 'Kontakttekst',
    'biz.leadgen_sub': 'Bygg salgsprosessen steg for steg — fra research til ferdig pitch.',
    'biz.step_research_name': 'Research', 'biz.step_research_desc': 'Finn lokale bedrifter med svak digital tilstedeværelse',
    'biz.step_lovable_name': 'Bygg', 'biz.step_lovable_desc': 'Generer Lovable-prompt fra Google Maps-data',
    'biz.step_sales_name': 'Pitch', 'biz.step_sales_desc': 'Skriv kontakttekst og prisstrategi for salg',
    'biz.step_higgs_name': 'Animasjon', 'biz.step_higgs_desc': 'Generer Higgsfield-motion-prompt for wow-effekt',
    'biz.higgs_paste': 'Merkevare / bransje-kontekst (valgfritt)',
    'biz.higgs_placeholder': 'Lim inn kort om bedriftens stil, bransje og ønsket uttrykk…',
    'biz.leadgen_generate': 'Generer og kopier prompt',
    'biz.leadgen_workspace': 'Arbeidsflate',
    'biz.theme_label': 'Design-tema',
    'biz.theme_standard': 'Standard/ingen preferanse',
    'biz.theme_warm': 'Varm håndverker',
    'biz.theme_cool': 'Kjølig teknisk',
    'biz.theme_premium': 'Premium minimal',
    'biz.tpl_label': 'Template',
    'biz.tpl_none': 'Ingen template — la Lovable designe fritt',
    'biz.tpl_none_desc': 'Lovable bygger struktur fra bunnen. Bruker flest kreditter.',
    'biz.tpl_open': 'Åpne mal i Lovable',
    'biz.tpl_not_built': 'Mal ikke bygget ennå',
    'biz.tpl_dirty': 'Ekte kundeside — må renses',
    'biz.tpl_handverker': 'Håndverker — visuell',
    'biz.tpl_handverker_desc': 'Flislegger, murer, snekker, maler. Krever gode prosjektbilder.',
    'biz.city': 'Sted', 'biz.industry': 'Bransje (valgfritt)',
    'biz.name': 'Bedriftnavn',
    'biz.select_customer': 'Velg kunde…',
    'biz.maps_paste': 'Google Maps-utklipp',
    'biz.maps_placeholder': 'Lim inn alt kopiert fra Google Maps…',
    'biz.contact_paste': 'Lim inn åpningstider og Google-anmeldelser her...',
    'biz.contact_placeholder': 'Lim inn råtekst med åpningstider og de viktigste kundeanmeldelsene fra bedriftens Google-profil her...',
    ...
    'biz.status_lead': 'Lead', 'biz.status_tilbud': 'Tilbud', 'biz.status_kontrakt': 'Kontrakt',
    ...
    'biz.margin': 'Margin', 'biz.unit': 'Enhet', 'biz.gross': 'Bruttofortjeneste',
    'biz.accounting_tab': 'Kunder', 'biz.leads_tab': 'Leads', 'biz.pricing_tab': 'Priser',
    ...
    'biz.scenario_b_desc': 'Hosting via tredjepart. Ingen månedskostnad. Frie endringer de første 90 dagene, deretter gjelder gjenoppstartsgebyr.',
    'biz.scenario_c_desc': 'Hosting og SSL via Cloudflare Pages. Leverandøren overvåker og varsler ved avvik.',
    'biz.sa_title': 'Prosjektoverføring',
    'biz.sb_title': 'Serverløs Hosting',
    'biz.sc_title': 'Full Driftsavtale',
    'biz.sales_page_title': 'Nettside-pakker',
    'biz.sales_price_note': 'Alle priser inkl. mva. · Timesats 790 kr/t · Forskudd 25 % via Frilans Finans',
    'biz.onetime_delivery': 'Engangsleveranse',
    'biz.sa_f1': 'Komplett nettside etter dine krav',
    'biz.sa_f2': 'Skriftlig godkjenning før overføring',
    'biz.sa_f3': 'Kunden eier kildekoden 100%',
    'biz.sa_f4': 'Fremtidige endringer: 690 kr/t',
    'biz.sb_f1': 'Gratis hosting via Cloudflare Pages / Vercel / Netlify',
    'biz.sb_f2': 'SSL-sertifikat + tilpasset domene',
    'biz.sb_f3': 'Ingen månedskostnad',
    'biz.sb_f4': 'Endringer etter 90 dager: 490 kr oppstart + 690 kr/t',
    'biz.sc_lav_features': 'Hosting · SSL · overvåkning',
    'biz.sc_med_features': 'Alt i Lav + 3 endringer/mnd',
    'biz.sc_hoy_features': 'Alt i Medium + ukentlige oppdateringer',
    'biz.deposit': 'Forskudd', 'biz.deposit_paid': 'Betalt', 'biz.deposit_unpaid': 'Ikke betalt',
    'biz.deposit_25': 'Forskudd (25 %)', 'biz.deposit_copy_invoice': 'Kopier fakturatekst',
    'biz.deposit_hint': 'Forskudd 25 % · ikke-refunderbart',
    'biz.confirm_delete_title': 'Slette kunde?',
    'biz.confirm_delete_body': 'Er du sikker på at du vil slette {name}? Dette kan ikke angres.',
    'biz.delete': 'Slett',
    'biz.higgs_generate': '🎬 Generer animasjonsprompt',
    'biz.after_90_days': 'etter 90 dager',
    'biz.generate_token': 'Kopier kontraktlenke', 'biz.token_copied': 'Lenke kopiert (7 dager)',
    'biz.confirm_contract': 'Merk bekreftet', 'biz.confirmed_on': 'Bekreftet',
    'biz.token_error': 'Feil ved lenke-oppretting',
    'biz.sc_lav_f1': 'Hosting via Cloudflare Pages / Vercel', 'biz.sc_lav_f2': 'SSL-sertifikat og tilpasset domene',
    'biz.sc_lav_f3': 'Overvåkning med varsel ved avvik', 'biz.sc_lav_f4': 'Support og endringer: 690 kr/t',
    'biz.sc_med_f1': 'Alt i Lav-pakken', 'biz.sc_med_f2': '3 inkluderte endringer per måned',
    'biz.sc_med_f3': 'Overforbruk utover kvoten: 1 050 kr/t',
    'biz.sc_hoy_f1': 'Alt i Medium-pakken', 'biz.sc_hoy_f2': '1 oppdatering per uke',
    'biz.sc_hoy_f3': 'Overforbruk (> 1/uke): 1 050 kr/t',
    // Garderobe
    'wd.title': 'Garderobe', 'wd.sub': '{g} plagg · {o} antrekk',
    'wd.tab_closet': 'Klesskap', 'wd.tab_outfits': 'Antrekk',
    'wd.all': 'Alle', 'wd.show_archived': 'Arkivert',
    'wd.season': 'Sesong', 'wd.occasion': 'Anledning',
    'wd.side_overview': 'Oversikt', 'wd.side_favorites': 'Favoritt-antrekk',
    'wd.side_garments': 'Plagg', 'wd.side_value': 'Verdi', 'wd.side_most': 'Mest av',
    'wd.side_no_favs': 'Ingen favoritter enda. Trykk ☆ på et antrekk for å legge til.',
    'wd.side_fav_count': 'Favoritter', 'wd.side_most_empty': 'Ingen data',
    'wd.side_activity': 'Siste aktivitet', 'wd.side_no_activity': 'Ingen opplastinger enda',
    'wd.cat_top': 'Overdel', 'wd.cat_bottom': 'Underdel', 'wd.cat_outerwear': 'Yttertøy',
    'wd.cat_shoes': 'Sko', 'wd.cat_accessory': 'Tilbehør',
    'wd.season_summer': 'Sommer', 'wd.season_autumn_spring': 'Høst/Vår', 'wd.season_winter': 'Vinter',
    'wd.occ_everyday': 'Hverdag', 'wd.occ_school': 'Skole', 'wd.occ_church': 'Kirke',
    'wd.occ_training': 'Trening', 'wd.occ_party': 'Fest', 'wd.occ_dressy': 'Pent',
    'wd.empty_closet': 'Bygg din digitale garderobe',
    'wd.empty_closet_hint': 'Last opp klær én gang. Lag antrekk på sekunder.',
    'wd.empty_cta': 'Last opp første plagg', 'wd.empty_outfits_cta': 'Bygg ditt første antrekk',
    'wd.suggestions': 'Forslag', 'wd.suggest_upload': 'Last opp plagg', 'wd.suggest_outfit': 'Bygg antrekk',
    'wd.empty_outfits': 'Ingen antrekk enda',
    'wd.empty_outfits_hint': 'Sett sammen plagg til antrekk og tagg dem med sesong og anledning.',
    'wd.load_error': 'Kunne ikke laste garderoben. Sjekk nettforbindelsen.',
    'wd.retry': 'Prøv igjen',
    'wd.upload_title': 'Legg til plagg',
    'wd.choose_files': 'Velg bilder eller ta bilde',
    'wd.upload_hint': 'Fotografer på rolig bakgrunn for best resultat',
    'wd.auto_bg': 'Fjern bakgrunn automatisk',
    'wd.auto_bg_hint': 'AI-modell (~40 MB) lastes ned første gang og caches. Feiler den, beholdes originalbildet.',
    'wd.st_wait': 'Venter…', 'wd.st_prep': 'Klargjør…',
    'wd.st_model': 'Laster AI-modell… {p}%', 'wd.st_bg': 'Fjerner bakgrunn…',
    'wd.st_crop': 'Beskjærer…', 'wd.st_encode': 'Komprimerer…',
    'wd.st_ready': 'Klar ✓', 'wd.st_ready_orig': 'Klar (original beholdt)',
    'wd.st_error': 'Feil — prøv igjen', 'wd.saving': 'Lagrer…',
    'wd.save_all': 'Lagre alle', 'wd.saved_n': '{n} plagg lagret', 'wd.new_garment': 'Nytt plagg',
    'wd.name': 'Navn', 'wd.category': 'Kategori', 'wd.color': 'Farge', 'wd.brand': 'Merke', 'wd.brand_ph': 'Søk merke…',
    'wd.size': 'Størrelse', 'wd.price': 'Pris (kr)', 'wd.notes': 'Notater',
    'wd.subcategory': 'Type', 'wd.sub_none': '— velg type —',
    'wd.sub_tshirt': 'T-skjorte', 'wd.sub_polo': 'Piké', 'wd.sub_shirt': 'Skjorte',
    'wd.sub_sweater': 'Genser', 'wd.sub_hoodie': 'Hettegenser', 'wd.sub_pyjamas': 'Pyjamas',
    'wd.sub_jeans': 'Jeans', 'wd.sub_chinos': 'Chinos', 'wd.sub_joggers': 'Joggebukse',
    'wd.sub_shorts': 'Shorts', 'wd.sub_trainingshorts': 'Treningsshorts',
    'wd.sub_jacket': 'Jakke', 'wd.sub_windbreaker': 'Vindjakke', 'wd.sub_raincoat': 'Regnjakke',
    'wd.sub_winterjacket': 'Vinterjakke', 'wd.sub_blazer': 'Dressjakke',
    'wd.sub_sneakers': 'Sneakers', 'wd.sub_running': 'Løpesko', 'wd.sub_spikes': 'Piggsko',
    'wd.sub_formal': 'Formelle sko', 'wd.sub_sandals': 'Sandaler',
    'wd.sub_cap': 'Caps', 'wd.sub_beanie': 'Lue', 'wd.sub_belt': 'Belte',
    'wd.sub_socks': 'Sokker', 'wd.sub_scarf': 'Skjerf', 'wd.sub_bag': 'Bag', 'wd.sub_jewelry': 'Smykke',
    'wd.pick_color': 'Hent farge fra bilde', 'wd.picking': 'Klikk på plagget for å velge farge',
    'wd.pick_cancel': 'Avbryt fargevalg', 'wd.pick_no_img': 'Plagget har ikke bilde — velg farge manuelt',
    'wd.pick_failed': 'Kunne ikke lese farger fra bildet',
    'wd.color_palette': 'Vanlige farger', 'wd.color_custom': 'Egen',
    'wd.c_black': 'Svart', 'wd.c_charcoal': 'Koksgrå', 'wd.c_grey': 'Grå', 'wd.c_lightgrey': 'Lysegrå',
    'wd.c_white': 'Hvit', 'wd.c_offwhite': 'Offwhite', 'wd.c_cream': 'Krem',
    'wd.c_navy': 'Marineblå', 'wd.c_greyblue': 'Gråblå', 'wd.c_denim': 'Denimblå', 'wd.c_blue': 'Blå',
    'wd.c_lightblue': 'Lyseblå', 'wd.c_skyblue': 'Himmelblå', 'wd.c_teal': 'Turkis', 'wd.c_petrol': 'Petrol',
    'wd.c_green': 'Grønn', 'wd.c_olive': 'Oliven', 'wd.c_sage': 'Salviegrønn', 'wd.c_mint': 'Mint',
    'wd.c_forest': 'Mørkegrønn',
    'wd.c_red': 'Rød', 'wd.c_burgundy': 'Vinrød', 'wd.c_rust': 'Rustrød', 'wd.c_coral': 'Korall',
    'wd.c_pink': 'Rosa', 'wd.c_dustyrose': 'Støvet rosa', 'wd.c_purple': 'Lilla', 'wd.c_lilac': 'Syrin',
    'wd.c_beige': 'Beige', 'wd.c_sand': 'Sand', 'wd.c_camel': 'Kamel', 'wd.c_brown': 'Brun',
    'wd.c_darkbrown': 'Mørkebrun', 'wd.c_khaki': 'Khaki',
    'wd.c_yellow': 'Gul', 'wd.c_mustard': 'Sennepsgul', 'wd.c_orange': 'Oransje',
    'wd.hex_invalid': 'Ugyldig fargekode', 'wd.autosaved': 'Lagret ✓', 'wd.close': 'Lukk',
    'wd.size_eu': 'EU-størrelse', 'wd.size_waist': 'Livvidde (tommer)', 'wd.size_length': 'Benlengde (tommer)', 'wd.size_other': 'Annet',
    'wd.delete': 'Slett', 'wd.archive': 'Arkiver', 'wd.unarchive': 'Hent frem',
    'wd.delete_confirm_garment': 'Slette plagget? Fjernes også fra antrekk.',
    'wd.delete_confirm_outfit': 'Slette antrekket? Plaggene beholdes.',
    'wd.deleted': 'Slettet', 'wd.garment_saved': 'Plagg lagret',
    'wd.used_in': 'Brukes i {n} antrekk', 'wd.not_used': 'Ikke brukt i noen antrekk enda',
    'wd.new_outfit': 'Nytt antrekk', 'wd.edit_outfit': 'Rediger antrekk',
    'wd.outfit_name': 'Navn på antrekk', 'wd.outfit_name_ph': 'F.eks. «Søndag pent» eller «Sommer hverdag»',
    'wd.pick_garments': 'Velg plagg',
    'wd.need_name': 'Gi antrekket et navn', 'wd.need_items': 'Velg minst ett plagg',
    'wd.outfit_saved': 'Antrekk lagret',
    'wd.copy_text': 'Kopier som tekst', 'wd.share_img': 'Del som bilde',
    'wd.copy_wardrobe': 'Kopier garderobe',
    'wd.copied': 'Kopiert ✓', 'wd.copy_fail': 'Kopiering feilet',
    'wd.img_fail': 'Bilde-eksport feilet',
    'wd.txt_outfit': 'ANTREKK', 'wd.txt_wardrobe': 'GARDEROBE',
    'wd.txt_n_garments': '{n} plagg',
    ...
    'music.all': 'Alle',
    'music.instrument_piano': 'Piano', 'music.instrument_gitar': 'Gitar',
    'music.technique_akkord': 'Akkord', 'music.technique_fingerspill': 'Fingerspill',
    'music.technique_none': 'Ingen',
    'music.field_title': 'Tittel', 'music.field_artist': 'Artist',
    'music.field_instruments': 'Instrument', 'music.field_technique': 'Teknikk',
    'music.field_key': 'Toneart', 'music.field_capo': 'Capo',
    'music.field_video': 'Video-lenke', 'music.field_chords': 'Akkord-lenke',
    'music.field_notes': 'Notat',
    'music.open_video': 'Åpne video', 'music.open_chords': 'Akkorder',
    'music.empty': 'Ingen sanger enda', 'music.empty_hint': 'Legg til den første sangen i repertoaret ditt.',
    'music.no_songs_filter': 'Ingen treff med dette filteret',
    'music.delete_confirm': 'Slette denne sangen?',
    'music.saved': 'Sang lagret', 'music.deleted': 'Sang slettet',
    'music.load_error': 'Kunne ikke laste sanger', 'music.retry': 'Prøv igjen',
    'music.title_required': 'Tittel er påkrevd',
  },
  en: {
    // Nav
    'nav.ai': 'AI', 'nav.dashboard': 'Dashboard', 'nav.gym': 'Gym',
    ...
    'dash.open_in_todos': 'Open in Tasks →',
    ...
    'biz.mrr': 'MRR', 'biz.onetime_year': 'One-time this year',
    'biz.monthly_cost': 'Monthly cost', 'biz.monthly_result': 'Monthly result',
    'biz.deposit_outstanding': 'Outstanding deposit', 'biz.deposit_show': 'Show them →',
    'biz.avtale': 'Agreement', 'biz.kontrakt_betaling': 'Contract & payment',
    'biz.faresone': 'Danger zone', 'biz.close_panel': 'Close',
    'biz.panel_cta_lead': 'Schedule demo', 'biz.panel_cta_tilbud': 'Copy quote',
    'biz.panel_cta_kontrakt': 'Mark as active', 'biz.panel_cta_pauset': 'Reactivate',
    'biz.startdato': 'Start date', 'biz.bekreftet_dato': 'Confirmed date',
    'biz.customers': 'Customers',
    'biz.customer': 'Customer', 'biz.contact': 'Contact', 'biz.tier': 'Tier',
    'biz.business_model': 'Business model',
    'biz.bm_a': 'Scenario A: Full service agreement (Subscription)',
    'biz.bm_b': 'Scenario B: Free serverless hosting (One-off purchase)',
    'biz.bm_c': 'Scenario C: Full transfer (One-off)',
    'biz.bm_custom': 'Custom',
    'biz.profil': 'Profile',
    'biz.mrr_short': 'MRR',
    'biz.sc_a_desc': 'Ongoing operation and hosting. 25% non-refundable deposit before work starts.',
    'biz.sc_b_desc': 'Free serverless hosting. No code access for the customer.',
    'biz.sc_c_desc': 'Full transfer to the customer’s own Lovable account.',
    'biz.sc_a_recommended': 'Recommended',
    'biz.sc_a_f1': '1 month mutual notice period',
    'biz.sc_a_f2': 'Overuse billed separately',
    'biz.sc_b_f1': 'Changes via the agency, no code access',
    'biz.sc_b_f2': 'Reactivation fee {fee} kr after 90 days inactive + {rate} kr/hr',
    'biz.sc_c_f1': 'Customer fully owns the solution after transfer',
    'biz.sc_c_f2': 'Support after transfer: {rate} kr/hr',
    'biz.tier_incl_lav': 'Hosting, SSL, uptime — 0 changes',
    'biz.tier_incl_medium': 'Max 2 micro-changes/month',
    'biz.tier_incl_hoy': 'Weekly adjustments (1 session/week)',
    ...
    'biz.type_sales': 'Contact message',
    'biz.leadgen_sub': 'Build the sales process step by step — from research to finished pitch.',
    'biz.step_research_name': 'Research', 'biz.step_research_desc': 'Find local businesses with weak digital presence',
    'biz.step_lovable_name': 'Build', 'biz.step_lovable_desc': 'Generate a Lovable prompt from Google Maps data',
    'biz.step_sales_name': 'Pitch', 'biz.step_sales_desc': 'Write contact copy and pricing strategy for the sale',
    'biz.step_higgs_name': 'Animation', 'biz.step_higgs_desc': 'Generate a Higgsfield motion prompt for wow-effect',
    'biz.higgs_paste': 'Brand / industry context (optional)',
    'biz.higgs_placeholder': 'Paste a short note on the business style, industry and desired feel…',
    'biz.leadgen_generate': 'Generate & copy prompt',
    'biz.leadgen_workspace': 'Workspace',
    'biz.theme_label': 'Design theme',
    'biz.theme_standard': 'Standard/no preference',
    'biz.theme_warm': 'Warm craftsman',
    'biz.theme_cool': 'Cool technical',
    'biz.theme_premium': 'Premium minimal',
    'biz.tpl_label': 'Template',
    'biz.tpl_none': 'No template — let Lovable design freely',
    'biz.tpl_none_desc': 'Lovable builds the structure from scratch. Uses the most credits.',
    'biz.tpl_open': 'Open template in Lovable',
    'biz.tpl_not_built': 'Template not built yet',
    'biz.tpl_dirty': 'Real client site — needs cleaning',
    'biz.tpl_handverker': 'Craftsman — visual',
    'biz.tpl_handverker_desc': 'Tiler, mason, carpenter, painter. Requires good project photos.',
    'biz.city': 'City', 'biz.industry': 'Industry (optional)',
    'biz.name': 'Business name',
    'biz.select_customer': 'Select customer…',
    'biz.maps_paste': 'Google Maps Paste',
    'biz.maps_placeholder': 'Paste everything copied from Google Maps...',
    'biz.contact_paste': 'Paste opening hours and Google reviews here...',
    'biz.contact_placeholder': 'Paste raw text with opening hours and the most important customer reviews from the business Google profile here...',
    'biz.margin': 'Margin', 'biz.unit': 'Unit', 'biz.gross': 'Gross profit',
    ...
    'biz.status_lead': 'Lead', 'biz.status_tilbud': 'Quote', 'biz.status_kontrakt': 'Contract',
    ...
    'biz.accounting_tab': 'Customers', 'biz.leads_tab': 'Leads', 'biz.pricing_tab': 'Prices',
    'biz.scenario_a': 'Scenario A', 'biz.scenario_b': 'Scenario B', 'biz.scenario_c': 'Scenario C',
    ...
    'biz.scenario_b_desc': 'Hosting via third-party. No monthly fee. Free changes the first 90 days, then restart fee applies.',
    'biz.scenario_c_desc': 'Hosting and SSL via Cloudflare Pages. Provider monitors and alerts on issues.',
    'biz.sa_title': 'Project Transfer',
    'biz.sb_title': 'Serverless Hosting',
    'biz.sc_title': 'Full Service Agreement',
    'biz.sales_page_title': 'Website Packages',
    'biz.sales_price_note': 'All prices incl. VAT · Hourly rate 790 kr/hr · 25% deposit via Frilans Finans',
    'biz.onetime_delivery': 'One-time delivery',
    'biz.sa_f1': 'Complete website to your specifications',
    'biz.sa_f2': 'Written approval before handoff',
    'biz.sa_f3': 'Client owns 100% of the source code',
    'biz.sa_f4': 'Future changes: 690 kr/hr',
    'biz.sb_f1': 'Free hosting via Cloudflare Pages / Vercel / Netlify',
    'biz.sb_f2': 'SSL certificate + custom domain',
    'biz.sb_f3': 'No monthly fee',
    'biz.sb_f4': 'Changes after 90 days: 490 kr setup + 690 kr/hr',
    'biz.sc_lav_features': 'Hosting · SSL · monitoring',
    'biz.sc_med_features': 'Everything in Low + 3 changes/mo',
    'biz.sc_hoy_features': 'Everything in Medium + weekly updates',
    'biz.deposit': 'Deposit', 'biz.deposit_paid': 'Paid', 'biz.deposit_unpaid': 'Not paid',
    'biz.deposit_25': 'Deposit (25%)', 'biz.deposit_copy_invoice': 'Copy invoice text',
    'biz.deposit_hint': 'Deposit 25% · non-refundable',
    'biz.confirm_delete_title': 'Delete customer?',
    'biz.confirm_delete_body': 'Are you sure you want to delete {name}? This cannot be undone.',
    'biz.delete': 'Delete',
    'biz.higgs_generate': '🎬 Generate animation prompt',
    'biz.after_90_days': 'after 90 days',
    'biz.generate_token': 'Copy contract link', 'biz.token_copied': 'Link copied (7 days)',
    'biz.confirm_contract': 'Mark confirmed', 'biz.confirmed_on': 'Confirmed',
    'biz.token_error': 'Error creating link',
    'biz.sc_lav_f1': 'Hosting via Cloudflare Pages / Vercel', 'biz.sc_lav_f2': 'SSL certificate and custom domain',
    'biz.sc_lav_f3': 'Monitoring with alerts on issues', 'biz.sc_lav_f4': 'Support and changes: 690 kr/h',
    'biz.sc_med_f1': 'Everything in Low plan', 'biz.sc_med_f2': '3 included changes per month',
    'biz.sc_med_f3': 'Overuse beyond quota: 1,050 kr/h',
    'biz.sc_hoy_f1': 'Everything in Medium plan', 'biz.sc_hoy_f2': '1 update per week',
    'biz.sc_hoy_f3': 'Overuse (> 1/week): 1,050 kr/h',
    // Wardrobe
    'wd.title': 'Wardrobe', 'wd.sub': '{g} garments · {o} outfits',
    'wd.tab_closet': 'Closet', 'wd.tab_outfits': 'Outfits',
    'wd.all': 'All', 'wd.show_archived': 'Archived',
    'wd.season': 'Season', 'wd.occasion': 'Occasion',
    'wd.side_overview': 'Overview', 'wd.side_favorites': 'Favorite outfits',
    'wd.side_garments': 'Garments', 'wd.side_value': 'Value', 'wd.side_most': 'Most of',
    'wd.side_no_favs': 'No favorites yet. Tap ☆ on an outfit to add one.',
    'wd.side_fav_count': 'Favorites', 'wd.side_most_empty': 'No data',
    'wd.side_activity': 'Recent activity', 'wd.side_no_activity': 'No uploads yet',
    'wd.cat_top': 'Top', 'wd.cat_bottom': 'Bottom', 'wd.cat_outerwear': 'Outerwear',
    'wd.cat_shoes': 'Shoes', 'wd.cat_accessory': 'Accessory',
    'wd.season_summer': 'Summer', 'wd.season_autumn_spring': 'Autumn/Spring', 'wd.season_winter': 'Winter',
    'wd.occ_everyday': 'Everyday', 'wd.occ_school': 'School', 'wd.occ_church': 'Church',
    'wd.occ_training': 'Training', 'wd.occ_party': 'Party', 'wd.occ_dressy': 'Dressy',
    'wd.empty_closet': 'Build your digital wardrobe',
    'wd.empty_closet_hint': 'Upload clothes once. Build outfits in seconds.',
    'wd.empty_cta': 'Upload your first garment', 'wd.empty_outfits_cta': 'Build your first outfit',
    'wd.suggestions': 'Suggestions', 'wd.suggest_upload': 'Upload a garment', 'wd.suggest_outfit': 'Build an outfit',
    'wd.empty_outfits': 'No outfits yet',
    'wd.empty_outfits_hint': 'Combine garments into outfits and tag them with season and occasion.',
    'wd.load_error': 'Could not load your wardrobe. Check your connection.',
    'wd.retry': 'Retry',
    'wd.upload_title': 'Add garments',
    'wd.choose_files': 'Choose photos or take one',
    'wd.upload_hint': 'Shoot on a plain background for best results',
    'wd.auto_bg': 'Remove background automatically',
    'wd.auto_bg_hint': 'An AI model (~40 MB) is downloaded on first use and cached. If it fails, the original photo is kept.',
    'wd.st_wait': 'Waiting…', 'wd.st_prep': 'Preparing…',
    'wd.st_model': 'Loading AI model… {p}%', 'wd.st_bg': 'Removing background…',
    'wd.st_crop': 'Cropping…', 'wd.st_encode': 'Compressing…',
    'wd.st_ready': 'Ready ✓', 'wd.st_ready_orig': 'Ready (original kept)',
    'wd.st_error': 'Error — try again', 'wd.saving': 'Saving…',
    'wd.save_all': 'Save all', 'wd.saved_n': '{n} garments saved', 'wd.new_garment': 'New garment',
    'wd.name': 'Name', 'wd.category': 'Category', 'wd.color': 'Color', 'wd.brand': 'Brand', 'wd.brand_ph': 'Search brand…',
    'wd.size': 'Size', 'wd.price': 'Price (kr)', 'wd.notes': 'Notes',
    'wd.subcategory': 'Type', 'wd.sub_none': '— select type —',
    'wd.sub_tshirt': 'T-shirt', 'wd.sub_polo': 'Polo', 'wd.sub_shirt': 'Shirt',
    'wd.sub_sweater': 'Sweater', 'wd.sub_hoodie': 'Hoodie', 'wd.sub_pyjamas': 'Pyjamas',
    'wd.sub_jeans': 'Jeans', 'wd.sub_chinos': 'Chinos', 'wd.sub_joggers': 'Joggers',
    'wd.sub_shorts': 'Shorts', 'wd.sub_trainingshorts': 'Training shorts',
    'wd.sub_jacket': 'Jacket', 'wd.sub_windbreaker': 'Windbreaker', 'wd.sub_raincoat': 'Rain jacket',
    'wd.sub_winterjacket': 'Winter jacket', 'wd.sub_blazer': 'Blazer',
    'wd.sub_sneakers': 'Sneakers', 'wd.sub_running': 'Running shoes', 'wd.sub_spikes': 'Spikes',
    'wd.sub_formal': 'Dress shoes', 'wd.sub_sandals': 'Sandals',
    'wd.sub_cap': 'Cap', 'wd.sub_beanie': 'Beanie', 'wd.sub_belt': 'Belt',
    'wd.sub_socks': 'Socks', 'wd.sub_scarf': 'Scarf', 'wd.sub_bag': 'Bag', 'wd.sub_jewelry': 'Jewelry',
    'wd.pick_color': 'Pick colour from photo', 'wd.picking': 'Click the garment to pick its colour',
    'wd.pick_cancel': 'Cancel colour pick', 'wd.pick_no_img': 'No photo on this garment — pick a colour manually',
    'wd.pick_failed': 'Could not read colours from the photo',
    'wd.color_palette': 'Common colours', 'wd.color_custom': 'Custom',
    'wd.c_black': 'Black', 'wd.c_charcoal': 'Charcoal', 'wd.c_grey': 'Grey', 'wd.c_lightgrey': 'Light grey',
    'wd.c_white': 'White', 'wd.c_offwhite': 'Off-white', 'wd.c_cream': 'Cream',
    'wd.c_navy': 'Navy', 'wd.c_greyblue': 'Grey blue', 'wd.c_denim': 'Denim blue', 'wd.c_blue': 'Blue',
    'wd.c_lightblue': 'Light blue', 'wd.c_skyblue': 'Sky blue', 'wd.c_teal': 'Teal', 'wd.c_petrol': 'Petrol',
    'wd.c_green': 'Green', 'wd.c_olive': 'Olive', 'wd.c_sage': 'Sage', 'wd.c_mint': 'Mint',
    'wd.c_forest': 'Forest green',
    'wd.c_red': 'Red', 'wd.c_burgundy': 'Burgundy', 'wd.c_rust': 'Rust', 'wd.c_coral': 'Coral',
    'wd.c_pink': 'Pink', 'wd.c_dustyrose': 'Dusty rose', 'wd.c_purple': 'Purple', 'wd.c_lilac': 'Lilac',
    'wd.c_beige': 'Beige', 'wd.c_sand': 'Sand', 'wd.c_camel': 'Camel', 'wd.c_brown': 'Brown',
    'wd.c_darkbrown': 'Dark brown', 'wd.c_khaki': 'Khaki',
    'wd.c_yellow': 'Yellow', 'wd.c_mustard': 'Mustard', 'wd.c_orange': 'Orange',
    'wd.hex_invalid': 'Invalid colour code', 'wd.autosaved': 'Saved ✓', 'wd.close': 'Close',
    'wd.size_eu': 'EU size', 'wd.size_waist': 'Waist (inches)', 'wd.size_length': 'Inseam (inches)', 'wd.size_other': 'Other',
    'wd.delete': 'Delete', 'wd.archive': 'Archive', 'wd.unarchive': 'Unarchive',
    'wd.delete_confirm_garment': 'Delete this garment? It is also removed from outfits.',
    'wd.delete_confirm_outfit': 'Delete this outfit? The garments are kept.',
    'wd.deleted': 'Deleted', 'wd.garment_saved': 'Garment saved',
    'wd.used_in': 'Used in {n} outfits', 'wd.not_used': 'Not used in any outfit yet',
    'wd.new_outfit': 'New outfit', 'wd.edit_outfit': 'Edit outfit',
    'wd.outfit_name': 'Outfit name', 'wd.outfit_name_ph': 'E.g. “Sunday dressy” or “Summer everyday”',
    'wd.pick_garments': 'Pick garments',
    'wd.need_name': 'Give the outfit a name', 'wd.need_items': 'Pick at least one garment',
    'wd.outfit_saved': 'Outfit saved',
    'wd.copy_text': 'Copy as text', 'wd.share_img': 'Share as image',
    'wd.copy_wardrobe': 'Copy wardrobe',
    'wd.copied': 'Copied ✓', 'wd.copy_fail': 'Copy failed',
    'wd.img_fail': 'Image export failed',
    'wd.txt_outfit': 'OUTFIT', 'wd.txt_wardrobe': 'WARDROBE',
    'wd.txt_n_garments': '{n} garments',
    ...
    'music.all': 'All',
    'music.instrument_piano': 'Piano', 'music.instrument_gitar': 'Guitar',
    'music.technique_akkord': 'Chords', 'music.technique_fingerspill': 'Fingerstyle',
    'music.technique_none': 'None',
    'music.field_title': 'Title', 'music.field_artist': 'Artist',
    'music.field_instruments': 'Instrument', 'music.field_technique': 'Technique',
    'music.field_key': 'Key', 'music.field_capo': 'Capo',
    'music.field_video': 'Video link', 'music.field_chords': 'Chords link',
    'music.field_notes': 'Notes',
    'music.open_video': 'Open video', 'music.open_chords': 'Chords',
    'music.empty': 'No songs yet', 'music.empty_hint': 'Add the first song to your repertoire.',
    'music.no_songs_filter': 'No matches for this filter',
    'music.delete_confirm': 'Delete this song?',
    'music.saved': 'Song saved', 'music.deleted': 'Song deleted',
    'music.load_error': 'Could not load songs', 'music.retry': 'Retry',
    'music.title_required': 'Title is required',
  },
};
...
const NAV_TABS = [
  ...
  ['garderobe.html', 'garderobe', 'nav.garderobe', 'Garderobe'],
  ['musikk.html', 'musikk', 'nav.musikk', 'Musikk'],
