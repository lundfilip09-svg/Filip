...
const TRANSLATIONS = {
  no: {
    ...
    'biz.bm_a': 'Scenario A: Prosjektoverføring (Kunden eier selv)',
    'biz.bm_b': 'Scenario B: Serverløs gratis hosting (Engangskjøp)',
    'biz.bm_c': 'Scenario C: Full Driftsavtale (Abonnement)',
  ...
  en: {
    ...
    'biz.bm_a': 'Scenario A: Project transfer (Customer owns it)',
    'biz.bm_b': 'Scenario B: Free serverless hosting (One-off purchase)',
    'biz.bm_c': 'Scenario C: Full service agreement (Subscription)',
