...
const TRANSLATIONS = {
  no: {
    ...
    'ai.quick1': 'Kne i dag?', 'ai.quick2': 'Sprint-klar?',
    'ai.quick3': 'Uke-belastning', 'ai.quick4': 'Søvn → restitusjon', 'ai.quick5': 'Neste treningsdag',
    'ai.quick1_prompt': 'Er knesmerten i dag trygg nok til å trene?',
    'ai.quick2_prompt': 'Basert på siste 3 dagers kne og HRV — er jeg klar for sprintøkt?',
    'ai.quick3_prompt': 'Er ukesbelastningen min for høy, passe eller for lav akkurat nå?',
    'ai.quick4_prompt': 'Hva sier søvnscoren min om restitusjon de siste 5 dagene?',
    'ai.quick5_prompt': 'Hva bør tomorrows økt inneholde gitt kne, HRV og det jeg har gjort denne uken?',
  ...
  en: {
    ...
    'ai.quick1': 'Knee today?', 'ai.quick2': 'Sprint-ready?',
    'ai.quick3': 'Week load', 'ai.quick4': 'Sleep → recovery', 'ai.quick5': 'Next training day',
    'ai.quick1_prompt': "Is today's knee pain safe enough to train?",
    'ai.quick2_prompt': 'Based on last 3 days of knee and HRV — am I ready for a sprint session?',
    'ai.quick3_prompt': 'Is my weekly training load too high, right, or too low right now?',
    'ai.quick4_prompt': 'What does my sleep score say about my recovery over the last 5 days?',
    'ai.quick5_prompt': "What should tomorrow's session contain given my knee, HRV, and what I've done this week?",
